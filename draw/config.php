...
define("PIXMICAT_LANGUAGE", 'zh_cn'); // 語系語定
...
define("USE_UPSERIES", 0); // 是否啟用連貼機能 [開主題後自動指向到主題下以方便連貼] (是：1 否：0)
...
define("TRUST_HTTP_X_FORWARDED_FOR", 1); // 是否利用HTTP_X_FORWARDED_FOR抓取Proxy後的真實IP。注意檔頭可能被偽造，若無特別需要請勿開啟 (是：1 否：0)
...
define("STORAGE_MAX", 500000); // 附加圖檔總容量限制上限大小 (單位：KB)
define("ALLOW_UPLOAD_EXT", 'GIF|JPG|PNG|BMP|SWF'); // 接受之附加圖檔副檔名 (送出前表單檢查用，用 | 分隔)

// 連續投稿時間限制
define("RENZOKU", 30); // 連續投稿間隔秒數
define("RENZOKU2", 30); // 連續貼圖間隔秒數
...
define("TEMPLATE_FILE", 'inc_pixmicat-festival.tpl'); // 樣板位置
define("PAGE_DEF", 20); // 一頁顯示幾篇討論串
define("ADMIN_PAGE_DEF", 20); // 管理模式下，一頁顯示幾筆資料
define("RE_DEF", 15); // 一篇討論串最多顯示之回應筆數 (超過則自動隱藏，全部隱藏：0)
define("RE_PAGE_DEF", 30); // 回應模式一頁顯示幾筆回應內容 (分頁用，全部顯示：0)
define("MAX_RES", 0); // 回應筆數超過多少則不自動推文 (關閉：0)
define("MAX_AGE_TIME", 168); // 討論串可接受推文的時間範圍 (單位：小時，討論串存在超過此時間則回應皆不再自動推文 關閉：0)
...
define("DEFAULT_NOTITLE", '无题'); // 預設文章標題
define("DEFAULT_NONAME", 'YO ♂'); // 預設文章名稱
define("DEFAULT_NOCOMMENT", '无内容'); // 預設文章內文
